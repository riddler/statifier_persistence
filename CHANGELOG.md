...
fragment in [`changelog.d/`](https://github.com/riddler/statifier_persistence/blob/v0.19.0/changelog.d/README.md); the fragments are assembled
...
that matches `t:StatifierPersistence.Storage.Adapter.error/0`
