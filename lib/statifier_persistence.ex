defmodule StatifierPersistence do
  ...
  - `StatifierPersistence.Storage` - the identity-guarded facade over charts,
    positions, and execution records. Every load is guarded against the chart
  ...
  - `StatifierPersistence.Storage.Adapter` - the behaviour a backing store
    ...
    same bar.
  - `StatifierPersistence.Executions` - the lifecycle: `create/4`, `step/5`,
  ...
  it orders concurrent deliveries to one execution, defaulting to the adapter's own
  `lock_execution/3`.
  """
