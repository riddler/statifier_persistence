...
#### Manual Verification:
- [ ] The sabotage mutation for the new test was confirmed red and reverted,
...
- [ ] `mix gate.verify`.
- [ ] `mix test test/statifier_persistence/demo/ --trace` lists the restart
      test by name.

#### Manual Verification:
- [ ] Both sabotage mutations confirmed red and reverted, noted above their
      tests.
